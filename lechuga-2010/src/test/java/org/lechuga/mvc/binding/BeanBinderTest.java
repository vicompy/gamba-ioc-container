...
import org.lechuga.mvc.binding.BindingException;
...
public class BeanBinderTest {
	...
	public void test1() {
		...
		final ExampleBean eb = (ExampleBean) bm.doBind(ExampleBean.class, attr);

		final ExampleBean b = eb;
	 ...
	 * coincident, simplement l'ignora i no injecta, deixant a null.
	 */
	@Test
	public void test3() {
		final Map<String, String[]> attr = new HashMap<String, String[]>();
