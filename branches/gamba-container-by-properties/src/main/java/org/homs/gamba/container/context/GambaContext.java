...
import org.homs.gamba.container.entities.BeanDef;
import org.homs.gamba.container.entities.InjElem;
import org.homs.gamba.container.entities.MethodInj;
import org.homs.gamba.container.entities.InjElem.EInjType;
import org.homs.gamba.container.exception.GambaException;
import org.homs.gamba.container.parser.AbstractGambaParser;
...
public class GambaContext {
	 ...
	 */
	public GambaContext(final String propertiesFileName) throws GambaException {
		final AbstractGambaParser propParser = new GambaPropertiesParser(propertiesFileName);
		hashBeanDefs = propParser.computeHashBeanDefs();
	}
	...
	private Object constructWithInjection(final BeanDef beanDef) throws GambaException {
		...
		for (int i = 0; i < nArgs; i++) {
			final InjElem injElem = beanDef.constructorInj.injElems[i];
		...
		try {
			...
			throw new GambaException("error calling constructor: ", beanDef, e);
		}
