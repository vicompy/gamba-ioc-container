package gamba.container.benchmark;

import gamba.container.context.GambaContainer;
import gamba.container.context.GambaContext;
...
public class MainBenchMarkTest {
	...
	public void springBenchMarkTest() {
		final ClassPathResource res = new ClassPathResource("spring-context.xml");
	...
	public void gambaBenchMarkTest() {
		...
		final GambaContext context = GambaContainer.getContext("benchmark-context.properties");
